...
import db_struct from "@site/static/data/database/deco_item/deco_item.struct.json";
import db_data from "@site/static/data/database/deco_item/deco_item.data.json";
import fb_data from "@site/static/data/database/deco_item/deco_item.fb.json";
