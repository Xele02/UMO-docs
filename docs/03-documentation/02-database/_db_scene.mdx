...
import db_struct from "@site/static/data/database/scene/scene.struct.json";
import db_data from "@site/static/data/database/scene/scene.data.json";
import fb_data from "@site/static/data/database/scene/scene.fb.json";
