...
import db_struct from "@site/static/data/database/cos_item/cos_item.struct.json";
import db_data from "@site/static/data/database/cos_item/cos_item.data.json";
import fb_data from "@site/static/data/database/cos_item/cos_item.fb.json";
