...
import db_struct from "@site/static/data/database/system/system.struct.json";
import db_data from "@site/static/data/database/system/system.data.json";
import fb_data from "@site/static/data/database/system/system.fb.json";
