...
import db_struct from "@site/static/data/database/adventure/adventure.struct.json";
import db_data from "@site/static/data/database/adventure/adventure.data.json";
import fb_data from "@site/static/data/database/adventure/adventure.fb.json";
