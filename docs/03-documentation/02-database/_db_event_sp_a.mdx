...
import db_struct from "@site/static/data/database/event_sp_a/event_sp_a.struct.json";
import db_data from "@site/static/data/database/event_sp_a/event_sp_a.data.json";
import fb_data from "@site/static/data/database/event_sp_a/event_sp_a.fb.json";
