...
import db_struct from "@site/static/data/database/uc_item/uc_item.struct.json";
import db_data from "@site/static/data/database/uc_item/uc_item.data.json";
import fb_data from "@site/static/data/database/uc_item/uc_item.fb.json";
