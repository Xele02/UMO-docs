...
import db_struct from "@site/static/data/database/event_april_fool_d/event_april_fool_d.struct.json";
import db_data from "@site/static/data/database/event_april_fool_d/event_april_fool_d.data.json";
import fb_data from "@site/static/data/database/event_april_fool_d/event_april_fool_d.fb.json";
