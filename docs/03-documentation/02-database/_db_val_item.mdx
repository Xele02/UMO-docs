...
import db_struct from "@site/static/data/database/val_item/val_item.struct.json";
import db_data from "@site/static/data/database/val_item/val_item.data.json";
import fb_data from "@site/static/data/database/val_item/val_item.fb.json";
