...
import db_struct from "@site/static/data/database/event_april_fool_c/event_april_fool_c.struct.json";
import db_data from "@site/static/data/database/event_april_fool_c/event_april_fool_c.data.json";
import fb_data from "@site/static/data/database/event_april_fool_c/event_april_fool_c.fb.json";
