...
import db_struct from "@site/static/data/database/epi_item/epi_item.struct.json";
import db_data from "@site/static/data/database/epi_item/epi_item.data.json";
import fb_data from "@site/static/data/database/epi_item/epi_item.fb.json";
