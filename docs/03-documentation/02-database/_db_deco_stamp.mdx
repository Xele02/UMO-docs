...
import db_struct from "@site/static/data/database/deco_stamp/deco_stamp.struct.json";
import db_data from "@site/static/data/database/deco_stamp/deco_stamp.data.json";
import fb_data from "@site/static/data/database/deco_stamp/deco_stamp.fb.json";
