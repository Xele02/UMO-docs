...
* Id : <DatabaseValue database_name="diva" path={"CDENCMNHNGA_Divas/"+(9 - 1)+"/AHHJLDLAPAN_DivaId"} />
* Serie : <DatabaseValue database_name="diva" path={"CDENCMNHNGA_Divas/"+(9 - 1)+"/AIHCEGFANAM_Attr"} />
* Birthday : <DatabaseValue database_name="diva" path={"CDENCMNHNGA_Divas/"+(9 - 1)+"/DOAJJALOKLI_Month"} /> / <DatabaseValue database_name="diva" path={"CDENCMNHNGA_Divas/"+(9 - 1)+"/PKNONBBKCCP_Day"} />
...
export const DivaStatsRow = ({data, prevData, idx}) =>
{
  ...
  const col = list.map(c => {
    ...
    const val = data[c];
    const _path = "CDENCMNHNGA_Divas/"+(9 - 1)+"/CMCKNKKCNDK_StatsByLevel/"+idx+"/"+c;
...
{
  const stats = diva_data_db.CDENCMNHNGA_Divas[(9 - 1)].CMCKNKKCNDK_StatsByLevel;
  var prev = undefined;
