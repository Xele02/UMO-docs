...
import { TranslatedStringLink, TranslatedTextTable } from "@umo-generator/components/TranslatedString";

export const languagesFiles = [
    //{ name:"common", lang:["ja", "fr", "en"] },
   //{ name:"stringlitterals", lang:["ja", "fr", "en"] },
...
export const CostumeTextTable = () =>
{
  ...
  return (
    <TranslatedTextTable datas={data.concat(data_unlock)} 
